...
def run_ragas_evaluation(question, answer, retrieved_chunks, ground_truth, llm, embedding_model):
    ...
    Parameters:
        ...
        llm             : Your LangChain LLM (e.g. ChatGoogleGenerativeAI)
        embedding_model : Your LangChain embeddings (e.g. GoogleGenerativeAIEmbeddings)
...
# ── Step 3: How to use this in your main app ─────────────────────────────────
# In your main Streamlit file (app.py), add this:
#
#   from ragas_eval import run_ragas_evaluation, display_ragas_scores
#
#   # After you have: question, answer, similar_chunks, ground_truth
#   ground_truth = st.text_input("Expected correct answer (for evaluation):")
#
#   if st.button("Run RAGAS Evaluation") and ground_truth:
#       with st.spinner("Running RAGAS..."):
#           scores = run_ragas_evaluation(
#               question        = user_query,
#               answer          = answer,
#               retrieved_chunks= [chunk.page_content for chunk in similar_chunks],
#               ground_truth    = ground_truth,
#               llm             = llm,
